...
(function(){
  var fs, p, Message, bitcore, superagent, wallet, generateKeys, guid, request, simple, status, methods, start, stop, create, method, getContainer, toString$ = {}.toString, out$ = typeof exports != 'undefined' && exports || this;
  fs = require('fs');
