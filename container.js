...
(function(){
  var fs, p, Message, bitcore, superagent, wallet, generateKeys, guid, request, simple, status, methods, start, stop, getContainerList, create, update, method, getContainer, out$ = typeof exports != 'undefined' && exports || this, toString$ = {}.toString;
  fs = require('fs');
